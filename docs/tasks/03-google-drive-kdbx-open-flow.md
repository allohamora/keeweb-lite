...
7. [ ] Persist and render Drive recent-file records with source locator/options and Drive identity binding.
8. [ ] Support recent Drive reopen with remembered key metadata scoped by Drive `fileId`.
