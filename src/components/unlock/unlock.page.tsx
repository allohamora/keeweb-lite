...
export const UnlockPage = ({ setSession }: UnlockPageProps) => {
  ...
  return (
    <main className="mx-auto flex min-h-svh w-full max-w-5xl px-3 pt-[calc(1rem+env(safe-area-inset-top))] pb-[calc(1rem+env(safe-area-inset-bottom))] sm:min-h-dvh sm:px-4 sm:py-6">
      <section className="mx-auto flex w-full max-w-5xl items-center justify-center py-2 text-zinc-100 sm:min-h-[78vh] sm:py-8">
